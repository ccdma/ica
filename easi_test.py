...
if __name__ == '__main__':
    easi_report(DATADICT["isin_1000"])
    easi_report(DATADICT["sqrtsin_1000"])
    easi_report(DATADICT["sin2_chebyt2_1000"])
    easi_report(DATADICT["chebyt2-5_1000"])
    easi_report(DATADICT["chebyt10_1000"])
    easi_report(DATADICT["sin+x_1000"])
    easi_report(DATADICT["sin+2x_1000"])
    easi_report(DATADICT["A*sin_1000"])
    easi_report(DATADICT["Adiv2*sin_1000"])    
    easi_report(DATADICT["Adiv2*sin_5000"])    
    easi_report(DATADICT["A*sqrtsin_1000"])